...
CREATE TABLE `room` (
  ...
  KEY `id_room_type_idx` (`id_room_type`),
  CONSTRAINT `id_room_seat` FOREIGN KEY (`id_room_seat`) REFERENCES `room_seat` (`id_room_seat`),
  CONSTRAINT `id_room_type` FOREIGN KEY (`id_room_type`) REFERENCES `room_type` (`id_room_type`)
...
INSERT INTO `room` VALUES (1,'hihih',1,1);
